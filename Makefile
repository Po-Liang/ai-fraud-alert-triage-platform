.PHONY: build-CreateAlertFunction build-ListAlertsFunction build-GetAlertFunction build-AnalyzeAlertFunction build-AnalysisWorkerFunction build-ReviewAlertFunction build-RagQueryFunction build-AnalyzeClaimFunction
